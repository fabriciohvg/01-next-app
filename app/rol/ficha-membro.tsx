    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleFieldChange("naturalidade", e.target.value)
                }
              />
            </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  handleFieldChange("estadoCivil", value)
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleFieldChange("orgaoEmissor", e.target.value)
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  handleFieldChange("escolaridade", value)
                }
              >
                <SelectTrigger>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label htmlFor="ondeCongrega">
                Onde congrega (Igreja Principal ou Congregação)
              </Label>
              <Input
                id="ondeCongrega"
                type="text"
                ...
                onChange={(e) =>
                  handleFieldChange("ondeCongrega", e.target.value)
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleFieldChange("numeroOrdem", e.target.value)
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) => handleFieldChange("membro", value)}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) => handleFieldChange("oficio", value)}
              >
                <SelectTrigger>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="presbitero-disponibilidade">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleFieldChange("pastorBatismo", e.target.value)
                }
              />
            </div>

            <div className="space-y-2">
              <Label htmlFor="igrejaBatismo">
                Igreja onde aconteceu o batismo
              </Label>
              <Input
                id="igrejaBatismo"
                type="text"
                ...
                onChange={(e) =>
                  handleFieldChange("igrejaBatismo", e.target.value)
                }
              />
            </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="pastorProfissao">
                Pastor que dirigiu a Profissão de Fé
              </Label>
              <Input
                id="pastorProfissao"
                type="text"
                ...
                onChange={(e) =>
                  handleFieldChange("pastorProfissao", e.target.value)
                }
              />
            </div>

            <div className="space-y-2">
              <Label htmlFor="igrejaProfissao">
                Igreja onde aconteceu a Profissão de Fé
              </Label>
              <Input
                id="igrejaProfissao"
                type="text"
                ...
                onChange={(e) =>
                  handleFieldChange("igrejaProfissao", e.target.value)
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  handleFieldChange("meioAdmissao", value)
                }
              >
                <SelectTrigger>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="batismo-profissao-fe">
                    Batismo e profissão de fé
                  </SelectItem>
                  <SelectItem value="transferencia">Transferência</SelectItem>
                  <SelectItem value="transferencia-responsaveis">
                    Transferência dos responsáveis
                  </SelectItem>
                  <SelectItem value="restauracao">Restauração</SelectItem>
                  <SelectItem value="jurisdicao-ex-officio">
                    Jurisdição ex officio
                  </SelectItem>
                  <SelectItem value="jurisdicao-pedido">
                    Jurisdição a pedido
                  </SelectItem>
                  <SelectItem value="jurisdicao-responsaveis">
                    Jurisdição sobre os responsáveis
                  </SelectItem>
                  <SelectItem value="designacao-presbitero">
                    Designação do presbítero
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="transferenciaPendente">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) => handleFieldChange("relacao", value)}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleFieldChange("relacionadoCom", e.target.value)
                }
              />
            </div>
          </div>
